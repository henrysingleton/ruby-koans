...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_regexp_can_search_a_string_for_matching_content
    assert_equal "match", "some matching content"[/match/] #intersting shorthand
  end
  ...
  #they keep matching after the first character match. 
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    assert_equal "start", "start end"[/\Astart/] #I did not know of the distinction between the start of the string vs the start of the line (^)
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    assert_equal "Gray", $1
    assert_equal "James", $2 #where did these get defined? 
  end
