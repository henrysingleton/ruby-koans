...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments
    assert_equal Array, method_with_keyword_arguments.class #it has a class of array because that is the return value
    assert_equal [1, 'two' ], method_with_keyword_arguments
    assert_equal ['one','two'], method_with_keyword_arguments(one: 'one') #two also exists because of the argument's default value
